...
public class proyecto {
    ...
    * 
    * @exception RuntimeException Recibido cuando
    * se introducen valores que no coinciden con los tipo de parametros del método.
    */
    ...
    */
    ...
    /**
    * Cálculo del menor de los 2 números introducidos y almacena
    * en la @param menor el valor mínimo de ambos números.
    * 
    * @param Valor1 Valor númerico entero introducido por el usuario.
    * 
    * @param Valor2 Valor númerico entero introducido por el usuario.
    ...
    * @return Devuelve el mayor de tipo entero.
    * 
    * @deprecated Desaconsejado su uso debido a implementación de un método
    * que no contiene fallos al recibir dos valores iguales.
    */
